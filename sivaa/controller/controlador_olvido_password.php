	...
	$consulta_correo = $sqlcorreo->select_correo($correo);
       ...
       if ($consulta_correo != 0) {
        ...
        $mensaje = "
           Buen dia, $correo
           <br /><br />
           Este es un mensaje para restablecer su contraseña, haga clic en el siguiente enlace para confirmar el restablecimiento de su contraseña, si no solo ignore este correo electrónico,
           <br /><br />
          ...
          exit;
            ...
            echo '<script language="javascript">alert("Se envio un mensaje al correo: '.$correo.' para realizar el cambio de contraseña ");</script>'; 
...
if ($_POST['recuperar_pass'] == 1) {
    ...
    if($pass == $valida_pass){
        ...
        echo "<script> alert('La contraseña no es correcta en alguno de los campos!'); </script>";
        echo '<script>document.location.href="../index.php" </script>';
    }
  }
